...
def multiply(number1=None,number2=None,toSymbol=None,fromSymbol=None,Number=None,plus=None,cut_fractional_zeros=None,show=True):
...
def divide(number1=None,number2=None,toSymbol=None,fromSymbol=None,Number=None,minus=None,compare=None,cut_fractional_zeros=None,cut_integer_zeros=None,show=True):
	def to_normal_size_integer(number1_string='',number2_string=''):
		def work_with_biggerString(stringBigger='',stringSmaller=''):
			for index in range(len(stringBigger)-len(stringSmaller)):
				stringSmaller='0'+stringSmaller;
...
def plus(number1=None,number2=None,toSymbol=None,fromSymbol=None,Number=None,show=True):
	def to_normal_size_integer(number1_string='',number2_string=''):
		def work_with_biggerString(stringBigger='',stringSmaller=''):
			for index in range(len(stringBigger)-len(stringSmaller)):
				stringSmaller='0'+stringSmaller;
...
def minus(number1=None,number2=None,toSymbol=None,fromSymbol=None,Number=None,show=True):
	def to_normal_size_integer(number1_string='',number2_string=''):
		def work_with_biggerString(stringBigger='',stringSmaller=''):
			for index in range(len(stringBigger)-len(stringSmaller)):
				stringSmaller='0'+stringSmaller;
...
#ch5.to(8);
#ch5.to(16);
ch2=plus(ch1,ch2,toSymbol,fromSymbol,Number);
ch3=minus(ch2,ch3,toSymbol,fromSymbol,Number);
ch4=multiply(ch3,ch4,toSymbol,fromSymbol,Number,plus,cut_fractional_zeros);
ch5=divide(ch4,ch5,toSymbol,fromSymbol,Number,minus,compare,cut_fractional_zeros,cut_integer_zeros);

#multCh=divide(multiply(minus(plus(ch1,ch2,toSymbol,fromSymbol,Number),ch3,toSymbol,fromSymbol,Number),ch4,toSymbol,fromSymbol,Number,plus,cut_fractional_zeros),ch5,toSymbol,fromSymbol,Number,minus,compare,cut_fractional_zeros,cut_integer_zeros);
